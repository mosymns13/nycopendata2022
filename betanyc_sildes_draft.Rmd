...
- Layout Agenda
- Introduction of us
- Background story to why we are here today (DSxD plug)
- Quick overview of R terminology
- Going over the basics of network analysis 
- Walkthrough RStudio Cloud setup (panes layout, introduce cheat sheets and primers in left hand panel as learning resources)
- Live coding/walkthrough of Rmd
- Introduce a few other datasets to explore
...
- Natalie --> Network basics, Live coding while Millie --> monitors chat
...
It was lovely having you today! Keep your eyes peeled for the upcoming "Future of Data Science" anthology by Data Science by Design (Twitter: `@DataScixDesign`)
